...
Source0  : https://files.pythonhosted.org/packages/75/0b/b7ea42dbb55ed0dc238246a5489dff59da228331acfcfc281800ef368b73/zc.lockfile-3.0.tar.gz
...
%prep
%setup -q -n zc.lockfile-3.0
cd %{_builddir}/zc.lockfile-3.0
pushd ..
cp -a zc.lockfile-3.0 buildavx2
popd
